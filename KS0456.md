...
Upload code 1 and power on , we will see the icon ![](./media/image-20230413143109261.png).
...
Place it into“on button A pressed”and 1 is modified into ![](media/81ec128a3a4bb86fed7d2f78bab20447.png)Duplicate![](media/81ec128a3a4bb86fed7d2f78bab20447.png)code string once, click the drop-down button to select“B”，then set“change item by -5”.
...
Replicate code string![](media/e0de4c7488b48605b292df5d3dd798dc.png)once “\>” is modified into “\<” and 25 is changed into 0, Leave it beneath ![](media/e0de4c7488b48605b292df5d3dd798dc.png)code string.
...
Go to“Basic”→“show leds” Lay it down beneath ![](media/6dbd99f5a6e4abe8ffd450d19b8a857b.png)block, then click“show leds”and the pattern ![](media/eab025b80ef24f1d5351bd3e06221bad.png)appears.

![](media/fe40fd39ae6abce0721d19cf86ef136d.png)

Duplicate ![](media/6dbd99f5a6e4abe8ffd450d19b8a857b.png)for 6 times. Separately leave them into the blank boxes behind “else if”. Set to“x≥23 and x\<68”,“x≥68 and x\<113 ”,“x≥113 and x\<158 ”,“x≥158 and x\<203 ”,“x≥203 and x\<248 ”,“x≥248 and x\<293 ”respectively.
...
Click“Basic”→“show number”, place it into“on shake”block, then change 0 into ![](media/b86b68744e64e4e9907ccb1fa0cb2af7.png) ,  Copy code string ![](media/b86b68744e64e4e9907ccb1fa0cb2af7.png)for 7 times; separately click the triangle button to select“logo up”,“logo down”,“screen up”,“screen down”,“tilt left”,“tilt right”and“free fall”, then respectively change 1 into 2, 3, 4, 5, 6, 7, 8.
...
Go to“Basic”and move out“pause (ms) 100”below theblock![](media/aa23874d61a27c3af5263746851f6fef.png), then set to 100ms.
...
You should see the LED matrix show the scrolling digit. Read the analog value of sound through the software![](media/f113707beadd9b5b2929315bf915541b.png).
